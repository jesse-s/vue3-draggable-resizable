...
function useState(initialState) {
  const state = (0,external_commonjs_vue_commonjs2_vue_root_Vue_.ref)(initialState);
...
function initState(props, emit) {
  ...
  const aspectRatio = (0,external_commonjs_vue_commonjs2_vue_root_Vue_.computed)(() => height.value / width.value);
  (0,external_commonjs_vue_commonjs2_vue_root_Vue_.watch)(width, newVal => {
    emit('update:w', newVal);
  }, {
    immediate: true
  });
  (0,external_commonjs_vue_commonjs2_vue_root_Vue_.watch)(height, newVal => {
    emit('update:h', newVal);
  }, {
    immediate: true
  });
  (0,external_commonjs_vue_commonjs2_vue_root_Vue_.watch)(top, newVal => {
    emit('update:y', newVal);
  });
  (0,external_commonjs_vue_commonjs2_vue_root_Vue_.watch)(left, newVal => {
    emit('update:x', newVal);
  });
  (0,external_commonjs_vue_commonjs2_vue_root_Vue_.watch)(enable, (newVal, oldVal) => {
  ...
  (0,external_commonjs_vue_commonjs2_vue_root_Vue_.watch)(() => props.active, newVal => {
    setEnable(newVal);
  });
  return {
    id: getId(),
...
function initParent(containerRef) {
  ...
  const parentWidth = (0,external_commonjs_vue_commonjs2_vue_root_Vue_.ref)(0);
  const parentHeight = (0,external_commonjs_vue_commonjs2_vue_root_Vue_.ref)(0);
...
function initLimitSizeAndMethods(props, parentSize, containerProps) {
  ...
  const limitProps = {
    minWidth: (0,external_commonjs_vue_commonjs2_vue_root_Vue_.computed)(() => {
      return resizingMinWidth.value;
    }),
    minHeight: (0,external_commonjs_vue_commonjs2_vue_root_Vue_.computed)(() => {
      return resizingMinHeight.value;
    }),
    maxWidth: (0,external_commonjs_vue_commonjs2_vue_root_Vue_.computed)(() => {
      let max = Infinity;
      if (props.parent) {
    ...
    maxHeight: (0,external_commonjs_vue_commonjs2_vue_root_Vue_.computed)(() => {
      let max = Infinity;
      if (props.parent) {
    ...
    minLeft: (0,external_commonjs_vue_commonjs2_vue_root_Vue_.computed)(() => {
      return props.parent ? 0 : -Infinity;
    }),
    minTop: (0,external_commonjs_vue_commonjs2_vue_root_Vue_.computed)(() => {
      return props.parent ? 0 : -Infinity;
    }),
    maxLeft: (0,external_commonjs_vue_commonjs2_vue_root_Vue_.computed)(() => {
      return props.parent ? parentWidth.value - width.value : Infinity;
    }),
    maxTop: (0,external_commonjs_vue_commonjs2_vue_root_Vue_.computed)(() => {
...
function initDraggableContainer(containerRef, containerProps, limitProps, draggable, emit, containerProvider, parentSize) {
  ...
  (0,external_commonjs_vue_commonjs2_vue_root_Vue_.watch)(dragging, (cur, pre) => {
    if (!pre && cur) {
      emit('drag-start', {
        x: x.value,
        y: y.value
...
function initResizeHandle(containerProps, limitProps, parentSize, props, emit) {
  ...
  const handlesFiltered = (0,external_commonjs_vue_commonjs2_vue_root_Vue_.computed)(() => props.resizable ? filterHandles(props.handles) : []);
  return {
    handlesFiltered,
    resizeHandleDown
  };
...
function watchProps(props, limits) {
  ...
  (0,external_commonjs_vue_commonjs2_vue_root_Vue_.watch)(() => props.w, newVal => {
    setWidth(newVal);
  });
  (0,external_commonjs_vue_commonjs2_vue_root_Vue_.watch)(() => props.h, newVal => {
    setHeight(newVal);
  });
  (0,external_commonjs_vue_commonjs2_vue_root_Vue_.watch)(() => props.x, newVal => {
    setLeft(newVal);
  });
  (0,external_commonjs_vue_commonjs2_vue_root_Vue_.watch)(() => props.y, newVal => {
    setTop(newVal);
  });
}
...
const VueDraggableResizable = (0,external_commonjs_vue_commonjs2_vue_root_Vue_.defineComponent)({
  ...
  setup(props, {
    ...
    const provideIdentity = (0,external_commonjs_vue_commonjs2_vue_root_Vue_.inject)('identity', Symbol());
    let containerProvider = null;
    if (provideIdentity === IDENTITY) {
      containerProvider = {
        updatePosition: (0,external_commonjs_vue_commonjs2_vue_root_Vue_.inject)('updatePosition'),
        getPositionStore: (0,external_commonjs_vue_commonjs2_vue_root_Vue_.inject)('getPositionStore'),
        disabled: (0,external_commonjs_vue_commonjs2_vue_root_Vue_.inject)('disabled'),
        adsorbParent: (0,external_commonjs_vue_commonjs2_vue_root_Vue_.inject)('adsorbParent'),
        adsorbCols: (0,external_commonjs_vue_commonjs2_vue_root_Vue_.inject)('adsorbCols'),
        adsorbRows: (0,external_commonjs_vue_commonjs2_vue_root_Vue_.inject)('adsorbRows'),
        setMatchedLine: (0,external_commonjs_vue_commonjs2_vue_root_Vue_.inject)('setMatchedLine')
      };
    }
    ...
    initDraggableContainer(containerRef, containerProps, limitProps, (0,external_commonjs_vue_commonjs2_vue_root_Vue_.toRef)(props, 'draggable'), emit, containerProvider, parentSize);
  ...
  render() {
    return (0,external_commonjs_vue_commonjs2_vue_root_Vue_.h)('div', {
      ...
      style: this.style
    }, [this.$slots.default && this.$slots.default(), ...this.handlesFiltered.map(item => (0,external_commonjs_vue_commonjs2_vue_root_Vue_.h)('div', {
...
/* harmony default export */ var DraggableContainer = ((0,external_commonjs_vue_commonjs2_vue_root_Vue_.defineComponent)({
  ...
  setup(props) {
    const positionStore = (0,external_commonjs_vue_commonjs2_vue_root_Vue_.reactive)({});
    ...
    const matchedRows = (0,external_commonjs_vue_commonjs2_vue_root_Vue_.computed)(() => state.matchedLine && state.matchedLine.row || []);
    const matchedCols = (0,external_commonjs_vue_commonjs2_vue_root_Vue_.computed)(() => state.matchedLine && state.matchedLine.col || []);
    const setMatchedLine = matchedLine => {
      state.matchedLine = matchedLine;
    };
    (0,external_commonjs_vue_commonjs2_vue_root_Vue_.provide)('identity', IDENTITY);
    (0,external_commonjs_vue_commonjs2_vue_root_Vue_.provide)('updatePosition', updatePosition);
    (0,external_commonjs_vue_commonjs2_vue_root_Vue_.provide)('getPositionStore', getPositionStore);
    (0,external_commonjs_vue_commonjs2_vue_root_Vue_.provide)('setMatchedLine', setMatchedLine);
    (0,external_commonjs_vue_commonjs2_vue_root_Vue_.provide)('disabled', (0,external_commonjs_vue_commonjs2_vue_root_Vue_.toRef)(props, 'disabled'));
    (0,external_commonjs_vue_commonjs2_vue_root_Vue_.provide)('adsorbParent', (0,external_commonjs_vue_commonjs2_vue_root_Vue_.toRef)(props, 'adsorbParent'));
    (0,external_commonjs_vue_commonjs2_vue_root_Vue_.provide)('adsorbCols', props.adsorbCols || []);
    (0,external_commonjs_vue_commonjs2_vue_root_Vue_.provide)('adsorbRows', props.adsorbRows || []);
    return {
      matchedRows,
      matchedCols
    };
