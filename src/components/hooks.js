...
function initState(props, emit) {
    ...
    var _o = useState(props.preventDeactivated), preventDeactivated = _o[0], setPreventDeactivated = _o[1];
    ...
    return {
        ...
        preventDeactivated: preventDeactivated,
        setEnable: setEnable,
        ...
        setPreventDeactivated: setPreventDeactivated,
        setWidthFun: function (val) { return setWidth(Math.floor(val)); },
        setHeightFun: function (val) { return setHeight(Math.floor(val)); },
        setTopFun: function (val) { return setTop(Math.floor(val)); },
        setLeftFun: function (val) { return setLeft(Math.floor(val)); }
    };
}
...
function initLimitSizeAndMethods(props, parentSize, containerProps) {
    ...
    var setWidthFun = containerProps.setWidthFun, setHeightFun = containerProps.setHeightFun, setTopFun = containerProps.setTopFun, setLeftFun = containerProps.setLeftFun;
...
function initDraggableContainer(containerRef, containerProps, limitProps, draggable, emit, containerProvider, parentSize) {
    var x = containerProps.left, y = containerProps.top, w = containerProps.width, h = containerProps.height, dragging = containerProps.dragging, id = containerProps.id, preventDeactivated = containerProps.preventDeactivated;
    ...
    (0, vue_1.onMounted)(function () {
        ...
        (0, utils_1.addEvent)(documentElement, DOWN_HANDLES, _unselect);
    ...
    (0, vue_1.onUnmounted)(function () {
        ...
        // document.documentElement.removeEventListener('mouseup', handleUp)
        // document.documentElement.removeEventListener('mousemove', handleDrag)
        (0, utils_1.removeEvent)(documentElement, DOWN_HANDLES, _unselect);
        (0, utils_1.removeEvent)(documentElement, UP_HANDLES, handleUp);
        (0, utils_1.removeEvent)(documentElement, MOVE_HANDLES, handleDrag);
    });
